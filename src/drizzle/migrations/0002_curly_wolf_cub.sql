...
ALTER TABLE "users" ADD COLUMN "contact_phone" varchar(255) NOT NULL;--> statement-breakpoint
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "restaurant_name_index" ON "restaurant" USING btree (name);--> statement-breakpoint
...
ALTER TABLE "users" DROP COLUMN IF EXISTS "score";--> statement-breakpoint
ALTER TABLE "users" ADD CONSTRAINT "users_contact_phone_unique" UNIQUE("contact_phone");--> statement-breakpoint
